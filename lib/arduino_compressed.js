...
// Copyright 2012 Google Inc.  Apache License 2.0
  ...
  Blockly.Blocks.math_arithmetic = {
    init: function() {
      this.jsonInit({
        ...
        }, {type: 'input_value', name: 'B', check: Blockly.Types.NUMBER.checkList}],
        inputsInline: !0,
  ...
  Blockly.Blocks.math_single = {
    init: function() {
      this.jsonInit({
        ...
        }, {type: 'input_value', name: 'NUM', check: Blockly.Types.DECIMAL.checkList}],
  ...
  Blockly.Blocks.math_change = {
    init: function() {
      ...
      var a = this;
      this.setTooltip(function() {return Blockly.Msg.MATH_CHANGE_TOOLTIP.replace('%1', a.getFieldValue('VAR'));});
    },
  ...
  Blockly.Blocks.math_on_list = {
    ...
    updateType_: function(a) {'MODE' == a ? this.outputConnection.setCheck(Blockly.Types.ARRAY.output) : this.outputConnection.setCheck(Blockly.Types.NUMBER.output);},
    mutationToDom: function() {
      var a = document.createElement('mutation');
    ...
    init: function() {
      this.jsonInit({
        ...
        args0: [{
          ...
          name: 'DIVIDEND',
          check: Blockly.Types.NUMBER.checkList
        }, {type: 'input_value', name: 'DIVISOR', check: Blockly.Types.NUMBER.checkList}],
        inputsInline: !0,
        output: Blockly.Types.NUMBER.output,
        colour: Blockly.Blocks.math.HUE,
    ...
    init: function() {
      this.jsonInit({
        ...
        args0: [{
          ...
          name: 'LOW',
          check: Blockly.Types.NUMBER.checkList
        }, {type: 'input_value', name: 'HIGH', check: Blockly.Types.NUMBER.checkList}],
        inputsInline: !0,
        output: Blockly.Types.NUMBER.output,
        colour: Blockly.Blocks.math.HUE,
    ...
    init: function() {
      this.jsonInit({
        ...
        args0: [{
          ...
          name: 'FROM',
          check: Blockly.Types.NUMBER.checkList
        }, {type: 'input_value', name: 'TO', check: Blockly.Types.NUMBER.checkList}],
        inputsInline: !0,
        output: Blockly.Types.NUMBER.output,
        colour: Blockly.Blocks.math.HUE,
  ...
  Blockly.Blocks.procedures_defnoreturn = {
    ...
    customContextMenu: function(a) {
      ...
      a.push(b);
      if (!this.isCollapsed()) for (e = 0; e < this.arguments_.length; e++) b = {enabled: !0}, c = this.arguments_[e], b.text = Blockly.Msg.VARIABLES_SET_CREATE_GET.replace('%1', c), d = goog.dom.createDom('field', null, c), d.setAttribute('name',
    ...
    getVarType: function(a) {return Blockly.Types.UNDEF;},
    argsTypes: {},
    setArgsType: function(a) {
      var b = this.arguments_, c;
      for (c in a) for (var d = 0, e = b.length; d < e; d++) c === b[d] && (this.argsTypes[c] = a[c]);
    },
    getArgType: function(a) {
      for (var b in this.argsTypes) if (b == a) return this.argsTypes[a];
      return null;
    }
  };
  Blockly.Blocks.procedures_defreturn = {
    ...
    getReturnType: function() {
      var a = Blockly.Types.NULL, b = this.getInputTargetBlock('RETURN');
  ...
  Blockly.Blocks.procedures_callnoreturn = {
    ...
    renameVar: function(a, b) {for (var c = 0; c < this.arguments_.length; c++) Blockly.Names.equals(a, this.arguments_[c]) && (this.arguments_[c] = b, this.getField('ARGNAME' + c).setValue(b));},
    customContextMenu: function(a) {
      var b = {enabled: !0};
  ...
  Blockly.Blocks.procedures_callreturn = {
    ...
    getBlockType: function() {return Blockly.Procedures.getDefinition(this.getProcedureCall(), this.workspace).getReturnType();}
  };
  ...
  Blockly.Blocks.controls_repeat_ext = {
    init: function() {
      this.jsonInit({
        ...
        args0: [{type: 'input_value', name: 'TIMES', check: Blockly.Types.NUMBER.checkList}],
        previousStatement: null,
        nextStatement: null,
    ...
    init: function() {
      this.jsonInit({
        ...
        args0: [{type: 'field_variable', name: 'VAR', variable: null}, {
          ...
          check: Blockly.Types.NUMBER.checkList,
          align: 'RIGHT'
        }, {type: 'input_value', name: 'BY', check: Blockly.Types.NUMBER.checkList, align: 'RIGHT'}],
        inputsInline: !0,
        previousStatement: null,
        nextStatement: null,
        colour: Blockly.Blocks.loops.HUE,
      ...
      var a = this;
      this.setTooltip(function() {return Blockly.Msg.CONTROLS_FOR_TOOLTIP.replace('%1', a.getFieldValue('VAR'));});
    }, customContextMenu: function(a) {
      if (!this.isCollapsed()) {
  ...
  Blockly.Blocks.text_append = {
    init: function() {
      ...
      this.setNextStatement(!0);
      var a = this;
      this.setTooltip(function() {return Blockly.Msg.TEXT_APPEND_TOOLTIP.replace('%1', a.getFieldValue('VAR'));});
    },
  ...
  Blockly.Blocks.text_prompt_ext = {
    init: function() {
      var a = [[Blockly.Msg.TEXT_PROMPT_TYPE_TEXT, Blockly.Types.TEXT.output], [Blockly.Msg.TEXT_PROMPT_TYPE_NUMBER, Blockly.Types.NUMBER.output]];
    ...
    updateType_: function(a) {this.outputConnection.setCheck(a == Blockly.Types.NUMBER.output ? Blockly.Types.NUMBER.checkList : Blockly.Types.TEXT.checkList);},
    mutationToDom: function() {
      var a = document.createElement('mutation');
  ...
  Blockly.Blocks.text_prompt = {
    init: function() {
      ...
      this.setTooltip(function() {return b.getFieldValue('TYPE') == Blockly.Types.TEXT.output ? Blockly.Msg.TEXT_PROMPT_TOOLTIP_TEXT : Blockly.Msg.TEXT_PROMPT_TOOLTIP_NUMBER;});
    },
  ...
  Blockly.Blocks.logic_negate = {
    init: function() {
      this.jsonInit({
        ...
        args0: [{type: 'input_value', name: 'BOOL', check: Blockly.Types.BOOLEAN.checkList}],
        output: Blockly.Types.BOOLEAN.output,
  ...
  Blockly.Blocks.logic_null = {
    ...
    }, getBlockType: function() {return Blockly.Types.NULL;}
  };
  ...
  Blockly.Blocks.lists_getIndex = {
    init: function() {
      ...
      this.removeInput('AT');
      this.removeInput('ORDINAL', !0);
      a ? (this.appendValueInput('AT').setCheck(Blockly.Types.NUMBER.checkList), Blockly.Msg.ORDINAL_NUMBER_SUFFIX && this.appendDummyInput('ORDINAL').appendField(Blockly.Msg.ORDINAL_NUMBER_SUFFIX)) : this.appendDummyInput('AT');
  ...
  Blockly.Blocks.lists_getSublist = {
    init: function() {
      ...
      this.removeInput('AT' + a);
      this.removeInput('ORDINAL' + a, !0);
      b ? (this.appendValueInput('AT' + a).setCheck(Blockly.Types.NUMBER.checkList), Blockly.Msg.ORDINAL_NUMBER_SUFFIX && this.appendDummyInput('ORDINAL' + a).appendField(Blockly.Msg.ORDINAL_NUMBER_SUFFIX)) :
  ...
  Blockly.Blocks.lists_split = {
    init: function() {
      var a = this,
        b = new Blockly.FieldDropdown([[Blockly.Msg.LISTS_SPLIT_LIST_FROM_TEXT, 'SPLIT'], [Blockly.Msg.LISTS_SPLIT_TEXT_FROM_LIST, 'JOIN']], function(b) {a.updateType_(b);});
      this.setHelpUrl(Blockly.Msg.LISTS_SPLIT_HELPURL);
      this.setColour(Blockly.Blocks.lists.HUE);
      this.appendValueInput('INPUT').setCheck(Blockly.Types.TEXT.checkList).appendField(b, 'MODE');
      this.appendValueInput('DELIM').setCheck(Blockly.Types.TEXT.checkList).appendField(Blockly.Msg.LISTS_SPLIT_WITH_DELIMITER);
      this.setInputsInline(!0);
      this.setOutput(!0, 'Array');
      this.setTooltip(function() {
    ...
    updateType_: function(a) {'SPLIT' == a ? (this.outputConnection.setCheck('Array'), this.getInput('INPUT').setCheck(Blockly.Types.TEXT.checkList)) : (this.outputConnection.setCheck(Blockly.Types.TEXT.checkList), this.getInput('INPUT').setCheck('Array'));},
    mutationToDom: function() {
      var a =
  ...
  Blockly.Blocks.variables_get = {
    ...
    getBlockType: function() {return [Blockly.Types.UNDEF, this.getFieldValue('VAR')];},
    getVarType: function(a) {return [Blockly.Types.UNDEF, this.getFieldValue('VAR')];}
  };
...
*/
  ...
  Blockly.Blocks.arduino_functions = {
    init: function() {
      ...
      this.contextMenu = !1;
    }, getArduinoLoopsInstance: function() {return !0;}
  };
  ...
  Blockly.Blocks.servo_read = {
    ...
    }, getBlockType: function() {return Blockly.Types.NUMBER;}, updateFields: function() {
  ...
  Blockly.Blocks.io_tone = {
    ...
    onchange: function(a) {this.workspace && a.type != Blockly.Events.MOVE && a.type != Blockly.Events.UI && (a = Blockly.Arduino.valueToCode(this, 'FREQUENCY', Blockly.Arduino.ORDER_ATOMIC), 31 > a || 65535 < a ? this.setWarningText(Blockly.Msg.ARD_TONE_WARNING, 'io_tone') : this.setWarningText(null, 'io_tone'));},
    getBlockType: function() {return Blockly.Types.NUMBER;}
  };
  ...
  Blockly.Blocks.spi_setup = {
    init: function() {
      ...
      this.appendDummyInput().appendField(Blockly.Msg.ARD_SPI_SETUP_SHIFT).appendField(new Blockly.FieldDropdown([[Blockly.Msg.ARD_SPI_SETUP_MSBFIRST, 'MSBFIRST'], [Blockly.Msg.ARD_SPI_SETUP_LSBFIRST,
        'LSBFIRST']]), 'SPI_SHIFT_ORDER');
      ...
      this.appendDummyInput().appendField(Blockly.Msg.ARD_SPI_SETUP_MODE).appendField(new Blockly.FieldDropdown([[Blockly.Msg.ARD_SPI_SETUP_MODE0, 'SPI_MODE0'], [Blockly.Msg.ARD_SPI_SETUP_MODE1, 'SPI_MODE1'], [Blockly.Msg.ARD_SPI_SETUP_MODE2, 'SPI_MODE2'], [Blockly.Msg.ARD_SPI_SETUP_MODE3, 'SPI_MODE3']]),
        'SPI_MODE');
      this.setTooltip(Blockly.Msg.ARD_SPI_SETUP_TIP);
    },
    getSpiSetupInstance: function() {return this.getFieldValue('SPI_ID');},
  ...
  Blockly.Blocks.spi_transfer = {
    init: function() {
      var a = [[Blockly.Msg.ARD_SPI_TRANS_NONE, 'none']].concat(Blockly.Arduino.Boards.selected.digitalPins);
    ...
    onchange: function(a) {
      if (this.workspace && a.type != Blockly.Events.MOVE && a.type != Blockly.Events.UI) {
        a = this.getFieldValue('SPI_ID');
        for (var b = Blockly.mainWorkspace.getTopBlocks(), c = !1, d = 0, e = b.length; d < e; d++) {
          var f = b[d].getSpiSetupInstance;
          f && (f = f.call(b[d]), a == f && (c = !0));
        }
        c ? this.setWarningText(null, 'spi_setup') : this.setWarningText(Blockly.Msg.ARD_SPI_TRANS_WARN1.replace('%1',
          a), 'spi_setup');
      }
    },
    getBlockType: function() {return Blockly.Types.NUMBER;},
    updateFields: function() {
      var a = this.getField('SPI_SS'), b = a.getValue();
      a.menuGenerator_ = [[Blockly.Msg.ARD_SPI_TRANS_NONE, 'none']].concat(Blockly.Arduino.Boards.selected.digitalPins);
  ...
  Blockly.Blocks.base_map = {
    init: function() {
      ...
      this.appendValueInput('NUM').appendField(Blockly.Msg.ARD_MAP).setCheck(Blockly.Types.NUMBER.checkList);
      this.appendValueInput('DMAX').appendField(Blockly.Msg.ARD_MAP_VAL).setCheck(Blockly.Types.NUMBER.checkList);
  ...
  Blockly.Blocks.stepper_config = {
    init: function() {
      var a = new Blockly.FieldDropdown([[Blockly.Msg.ARD_STEPPER_TWO_PINS, 'TWO'], [Blockly.Msg.ARD_STEPPER_FOUR_PINS, 'FOUR']], function(a) {this.sourceBlock_.updateShape_('FOUR' == a);});
  ...
  Blockly.Blocks.io_digitalread = {
    ...
    }, getBlockType: function() {return Blockly.Types.BOOLEAN;}, updateFields: function() {
      Blockly.Arduino.Boards.refreshBlockFieldDropdown(this,
        'PIN', 'digitalPins');
    }
  };
  Blockly.Blocks.io_builtin_led = {
    init: function() {
      this.setHelpUrl('http://arduino.cc/en/Reference/DigitalWrite');
      this.setColour(Blockly.Blocks.io.HUE);
      this.appendValueInput('STATE').appendField(Blockly.Msg.ARD_BUILTIN_LED).appendField(new Blockly.FieldDropdown(Blockly.Arduino.Boards.selected.builtinLed), 'BUILT_IN_LED').appendField(Blockly.Msg.ARD_WRITE_TO).setCheck(Blockly.Types.BOOLEAN.checkList);
      this.setInputsInline(!1);
      this.setPreviousStatement(!0, null);
      this.setNextStatement(!0, null);
      this.setTooltip(Blockly.Msg.ARD_BUILTIN_LED_TIP);
    },
    updateFields: function() {Blockly.Arduino.Boards.refreshBlockFieldDropdown(this, 'BUILT_IN_LED', 'builtinLed');},
    getBlockType: function() {return Blockly.Types.BOOLEAN;}
  };
  ...
  Blockly.Blocks.io_highlow = {
    init: function() {
      ...
      this.setColour(Blockly.Blocks.io.HUE);
      this.appendDummyInput().appendField(new Blockly.FieldDropdown([[Blockly.Msg.ARD_HIGH, 'HIGH'], [Blockly.Msg.ARD_LOW, 'LOW']]), 'STATE');
      this.setOutput(!0, Blockly.Types.BOOLEAN.output);
    ...
    init: function() {
      this.jsonInit({
        ...
        args0: [{
          ...
          name: 'PULSEPIN',
          options: Blockly.Arduino.Boards.selected.digitalPins
        }, {type: 'input_value', name: 'TIMEOUT', check: Blockly.Types.NUMBER.check}],
        output: Blockly.Types.NUMBER.output,
        inputsInline: !0,
        colour: Blockly.Blocks.io.HUE,
  ...
  Blockly.Blocks.serial_setup = {
    ...
    getSerialSetupInstance: function() {return this.getFieldValue('SERIAL_ID');},
    updateFields: function() {
  ...
  Blockly.Blocks.serial_print = {
    ...
    onchange: function(a) {
      if (this.workspace && a.type != Blockly.Events.MOVE && a.type != Blockly.Events.UI) {
        a = this.getFieldValue('SERIAL_ID');
        for (var b = Blockly.mainWorkspace.getTopBlocks(), c = !1, d = 0; d < b.length; d++) {
          var e = b[d].getSerialSetupInstance;
          if (e && (e = e.call(b[d]), a == e)) {
            c = !0;
            break;
          }
        }
